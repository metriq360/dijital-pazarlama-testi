...
// Markdown karakterlerini e-posta için şık HTML etiketlerine dönüştüren fonksiyon
const formatMarkdownToHTML = (text) => {
    return text
        .replace(/### (.*)/g, '<h3 style="color:#f97316; margin-top:20px; font-family:sans-serif; border-bottom:1px solid #ffedd5; padding-bottom:5px;">$1</h3>')
